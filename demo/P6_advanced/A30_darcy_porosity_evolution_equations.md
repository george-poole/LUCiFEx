...
Governing equations for double solutal convection coupled to Darcy flow and porosity evolution by a $\text{C}_{(\text{s})}\to \text{C}_{(\text{aq})}$ dissolution reaction.
