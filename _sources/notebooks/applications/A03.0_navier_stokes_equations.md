...
&\begin{cases}
\nabla\cdot\textbf{u} = 0 & \\
\rho \left(\frac{\partial\textbf{u}}{\partial t}+\textbf{u}\cdot\nabla\textbf{u}\right)=-\nabla p + \nabla\cdot\tau + \textbf{f}(\textbf{x}, t) & \forall(\textbf{x}, t)\in\Omega\times[0,\infty) \\
...
\textbf{u}_{\text{E}}~,~\partial\Omega_{\text{E}} & \text{velocity essential boundary condition} \\
\boldsymbol{\tau}_{\text{N}}~,~\partial\Omega_{\text{N}} & \text{traction natural boundary condition} \\
...
\begin{align*}
F_1(\widetilde{\textbf{u}}^{n+1}, \textbf{v}) &= 
\int_\Omega\text{d}\Omega~\textbf{v}\cdot\frac{\widetilde{\textbf{u}}^{n+1}-\textbf{u}^n}{\Delta t^n} + \textbf{v}\cdot\mathcal{D}_{\textbf{u}}(\textbf{u}\cdot\nabla\textbf{u}) \\
